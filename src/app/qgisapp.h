...
class QgsEcoRestorationController;
class QgsMapLayer;
...
class APP_EXPORT QgisApp : public QMainWindow, private Ui::MainWindow
{
  ...
  public slots:
    ...
    */
    ...
    /**
     * Creates a blank project for an integrated application workflow.
     *
     * This public wrapper keeps the normal project-reset implementation
     * private while allowing application modules to invoke it without
     * string-based meta-object reflection.
     */
  ...
  private:
    ...
    */
    ...
    QgsEcoRestorationController *mEcoRestorationController = nullptr;
